    ...
    return <div className="flex justify-center items-center h-screen w-screen p-10 bg-black">
        <div className="h-full w-full flex  bg-green-500 rounded-xl">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center items-center gap-4 p-8 text-green-900">
                ...
                <h1 className="text-2xl md:text-5xl font-semibold">{"Create an account"}</h1>
                <p className="md:text-xl pb-10">Already have an account?<Link className="underline pl-2" href={"/login"}>Login</Link></p>
                <div className="flex flex-col gap-8">
                    <div className="flex gap-4 justify-center">
                        <Input onChange={(e:React.ChangeEvent<HTMLInputElement>) => {
                            setFirstName(e.target.value);
                        }} className="bg-green-300 w-full py-1 text-black placeholder-black focus:ring-2 focus:ring-green-700 focus:border-green-700 transition" placeholder="First Name" type="text" />
                        <Input onChange={(e) => {
                            setLastName(e.target.value);
                        }} className="bg-green-300 w-full py-1 text-black placeholder-black focus:ring-2 focus:ring-green-700 focus:border-green-700 transition" placeholder="Last Name" type="text" />
                    </div>
