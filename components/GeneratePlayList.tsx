...
const GeneratePlaylist = () => {
       ...
       return <div className="h-full w-full bg-[url(/login.png)]  bg-cover bg-[center_10%]  flex flex-col justify-between items-center">
              ...
              <div className="flex flex-col justify-center items-center  w-full gap-4 pb-12">
                     <div className="w-full md:w-1/2">
                            <div className="flex flex-row justify-center mx-4 md:mx-0 gap-x-2">
